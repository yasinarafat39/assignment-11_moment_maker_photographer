        ...
        <section className='mb-28'>
            <div className="hero " style={{ backgroundImage: `url(${banner})` }}>
                ...
                <div className="container flex flex-col items-start px-4 py-16 pb-24 mx-auto   lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-900">
                    ...
                    <h1 className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl mt-4"><span className='text-green-600'>EASIN ARAFAT</span></h1>
                    <p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl text-white">You want to hire a Professional Photographer for your event? <span className='hidden lg:block md:block'> </span> You can hire me as a Photographer to handle your events.</p>
